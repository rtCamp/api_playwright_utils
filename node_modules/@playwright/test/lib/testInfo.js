...
class TestInfoImpl {
  ...
  constructor(loader, project, workerParams, test, retry, addStepImpl) {
    ...
    this.outputDir = (() => {
      ...
      if (sameName.length > 1) uniqueProjectNamePathSegment = this.project.name + (sameName.indexOf(this.project) + 1);else uniqueProjectNamePathSegment = this.project.name;

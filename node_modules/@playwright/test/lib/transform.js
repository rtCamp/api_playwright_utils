...
function belongsToNodeModules(file) {
  ...
  if (file.includes(`${_path.default.sep}playwright${_path.default.sep}packages${_path.default.sep}playwright`)) return true;
  if (file.includes(`${_path.default.sep}playwright${_path.default.sep}tests${_path.default.sep}config${_path.default.sep}coverage.js`)) return true;
  return false;
}